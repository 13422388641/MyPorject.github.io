...
/******/ 	__webpack_require__.p = "/s.jasen.applinzi.com/ffun-fe/dist/";
/******/
...
var _mm     = {
    ...
    valueData   : function( value , type ){
        ...
        if( type === 'email' ) {
            var reg_ = /^([0-9A-Za-z\-_\.]+)@([0-9a-z]+\.[a-z]{2,3}(\.[a-z]{2})?)$/g;
            return reg_.test( value_ )
        }
    },
    //获取服务器地址
    ...
    getUrlParam  : function( name ){
        ...
        if( str && reg.test(str) ){
            var result      = window.location.search.substr(1).match(reg).toString();
