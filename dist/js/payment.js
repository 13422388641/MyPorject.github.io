...
/**
 * Created by jasen on 2017/11/19.
 */
...
var $                   = __webpack_require__(1);
var _mm                 = __webpack_require__(0);
var _pay                = __webpack_require__(74);
var paymentTemplate     = __webpack_require__(75);
...
var payment = {
    ...
    load : function(){
        var _this = this;
        //loading图片显示
        $('.payment-con').html("<div class='loading'></div>");
        _pay.topay(this.data , function( res ){
            //成功
            var paymentHtml = _mm.renderHtml( paymentTemplate , res );
            $('.payment-con').html( paymentHtml );
    ...
    getPaymentStatus : function(){
        ...
        this.timer = window.setInterval(function(){
            _pay.getPaymentStatus(_this.data , function( res ){
                //成功
                //服务端返回该订单状态为支付成功
                if( res === true ){
                    window.location.href = './order/detail.html?orderNo=' + _this.data.orderNo;
                }
            } , function( errMsg ){
                //失败
                $('.payment-con').html("<div class='payment-error'>errMsg</div>");
            })
        },3000)
    }
};
...
var _pay = {
    ...
    getPaymentStatus : function( data , suc , err ){
        _mm.request({
...
module.exports = "<p class=\"payment-con-p\">\r\n    订单提交成功，请您尽快支付！订单号：\r\n    <span class=\"orderNumber\">{{orderNo}}</span>\r\n</p>\r\n<p class=\"payment-con-tips\">请使用支付宝扫描下面得二维码进行支付</p>\r\n<p class=\"payment-con-pic\">\r\n    <img src=\"{{qrUrl}}\" alt=\"支付宝二维码\"/>\r\n</p>";
